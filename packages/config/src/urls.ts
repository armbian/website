...
export const ARMBIAN_URLS = {
  ...
  IMAGER_GITHUB: 'https://github.com/armbian/imager',
  IMAGER_RELEASES: 'https://github.com/armbian/imager/releases/download',
  IMAGER_CONTRIBUTING: 'https://github.com/armbian/imager/blob/main/CONTRIBUTING.md',
