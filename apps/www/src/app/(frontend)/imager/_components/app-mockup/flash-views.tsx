...
import { ACCENT, ACCENT_RGB, FLASH_STAGES } from './constants';
...
export function FlashHeader() {
  ...
  const osLogo =
    os?.distro === 'debian' ? '/imager/assets/debian.svg' : '/imager/assets/ubuntu.png';
  return (
    <div
          ...
          >
            ...
            <span
              ...
              style={{
                ...
                marginLeft: 4,
                paddingLeft: 8,
                borderLeft: `1px solid rgba(${ACCENT_RGB},0.2)`,
              }}
            >
              14.8 GB
            </span>
...
export function FlashStatus({ stage, progress }: { stage: number; progress: number }) {
  const c = useC();
  const current = FLASH_STAGES[stage] ?? FLASH_STAGES[0]!;
            ...
            <>
              <motion.div
                ...
                style={{
                  ...
                  boxShadow: `0 0 10px rgba(${ACCENT_RGB},0.4)`,
                }}
        ...
        <div className="mt-[20px] flex gap-[12px]">
          ...
          <div
            ...
            style={{
              ...
              boxShadow: clicking ? `0 0 0 3px rgba(${ACCENT_RGB},0.4)` : 'none',
            }}
          >
            Done
          </div>
