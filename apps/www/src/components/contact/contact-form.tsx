...
export function ContactForm() {
  ...
  return (
    <>
      ...
      >
        <input type="hidden" name="xnQsjsdp" value="8a3429ee12927ae9c27c07c12f33105a5c55ecef1dd8739be38e6f5a578e27ea" />
        <input type="hidden" name="zc_gad" value="" />
        <input type="hidden" name="xmIwtLD" value="24f594c268bd49456368bb68dec3340d6434d709a223dcf881a88fe0ddeafee28c5bef380d48302ac03d97b49a711f8e" />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            ...
            <input type="text" name="First Name" maxLength={40} required className={inputClass} placeholder="John" />
          </div>
          <div>
            <label className="block text-[11px] font-bold uppercase tracking-wider text-[rgb(var(--fg-3))] mb-2">
              {t('form_last_name')} <span className="text-[rgb(var(--brand))]">*</span>
            </label>
            <input type="text" name="Last Name" maxLength={80} required className={inputClass} placeholder="Doe" />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            ...
            <input type="text" name="Accounts.Account Name" maxLength={200} required className={inputClass} placeholder="Acme Inc." />
          </div>
          <div>
            <label className="block text-[11px] font-bold uppercase tracking-wider text-[rgb(var(--fg-3))] mb-2">
              {t('form_email')} <span className="text-[rgb(var(--brand))]">*</span>
            </label>
            <input type="email" name="Email" maxLength={100} required className={inputClass} placeholder="john@acme.com" />
          </div>
        </div>
