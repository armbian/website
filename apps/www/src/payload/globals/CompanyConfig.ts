      ...
      fields: [
        {
          name: 'street',
          type: 'text',
          defaultValue: 'Reboljeva ulica 5',
          admin: { width: '50%' },
        },
    ...
    },
    {
      ...
      fields: [
        { name: 'vatId', type: 'text', defaultValue: 'SI38201194', admin: { width: '33%' } },
        {
          name: 'iban',
          type: 'text',
          defaultValue: 'SI56 0400 0028 2106 011',
          admin: { width: '33%' },
        },
      ...
      fields: [
        {
          name: 'officeHoursDay',
          type: 'text',
          defaultValue: 'Every Wednesday',
          admin: { width: '33%' },
        },
        {
          name: 'calendlyOfficeHours',
          type: 'text',
          admin: { width: '33%', description: 'Calendly URL for community office hours' },
        },
        {
          name: 'calendlyConsultation',
          type: 'text',
          admin: { width: '33%', description: 'Calendly URL for paid consultation' },
        },
      ],
    },
  ],
